...
image::../images/CapturFiles_3.jpg[]

Le deuxième bouton est plus simple entrez +Chambre+ dans le champ *Nom* et validez. + (si la fenêtre "Bouton" disparait, cliquer une un des boutons déjà créés pour la faire réapparaitre)

image::../images/CapturFiles_4.jpg[]
...
Pour faire apparaitre le menu *Style*, cliquer sur *Aperçu* puis *Style* +


* Bordure : *Taille*: +5+, *Rayon*: +5+, *Style*: +groove+, *Couleur*: +Bleu+
* Ombre : *Taille*: +10+, +10+, +10+, *Couleur*: +Bleu Clair +

image::../images/CapturFiles_6.jpg[]

Valider le style et sauvegardez votre thème maintenant. +

Voici le résultat: +

image::../images/démo1.png[]

A ce stade, aucune page n'est ajoutée, le bouton *Design* est actif, en cliquant dessus, le plugin va creer l'ensemble des pages nécesasires (Le chapitre suivant expose plus en détail le bouton *Design*).+
Il est nécessaire après création des pages de sauvegarder votre *thème*. Le bouton *Design* se grise et le bouton *BootSrap* s'active.
Cliquer sur le bouton *BootStap* permet le code dans la page principale (home).
==== Design et Bootstrap
...
Les images qui serviront aux pages secondaires seront rajoutées avec le Gestionnaire d'images, pour notre thème elles seront au format de notre cadre principale et seront créés à l'aide du logiciel link:http://www.sweethome3d.com/fr/[SweetHome 3D] ou autres logiciels de votre choix.+

...
Le thème que nous désirons et pratiquement créer, ils nous restent plus qu'a configurer les <<partie_2#ajoutedition-dun-bouton,boutons>> et le <<partie_2#popover-du-style,style>>. +

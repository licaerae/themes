...
Le bouton *Sous-menu* permet d'afficher les entrées de sous-menu, Cliquez sur le bouton image:plus.png[role="img-thumbnail"] pour en rajouter une, le bouton image:trash.png[role="img-thumbnail"] permet d’effacer l'entrée. le bouton image:trash.png[role="img-thumbnail"] en haut à droite en édition permet d'éffacer le bouton. +
--

...
Le gestionnaire permet de gérer des catégories, celle par défaut est utilisé par le plugin, seul les images importées dans cette catégorie seront accessible dans les thèmes. Pour créer une nouvelle catégorie cliquez sur image:../images/gestionnaire3.png[]. +
Pour importer une image cliquez sur image:../images/gestionnaire4.png[], elle sera importé dans la catégorie sélectionné. +
{nbsp} +

image::../images/gestionnaire5.png[]
Une fois l'image importé, image:../images/cadretrash.png[] permet de la supprimer, image:../images/gestionnaire6.png[] ouvrira une boite dialogue donnant les infos suivantes :
